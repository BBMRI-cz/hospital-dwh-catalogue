# Generated by Django 5.2.9 on 2026-06-23 11:59
...
def create_metadata_schema(apps, schema_editor):
    if schema_editor.connection.vendor == 'postgresql':
        schema_editor.execute('CREATE SCHEMA IF NOT EXISTS metadata')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_metadata_schema, migrations.RunPython.noop),
        ...
        migrations.AddField(
            model_name='agent',
            name='contact_point',
            field=models.ForeignKey(blank=True, help_text='Contact information for this agent', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='agents', to='warehouse.contactpoint', verbose_name='Contact Point'),
        ),
        migrations.CreateModel(
            name='Dataset',
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, db_column='creator', help_text='dct:creator - agent who created this dataset', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creator_datasets', to='warehouse.agent', verbose_name='Creator')),
                ...
                ('source', models.ForeignKey(blank=True, db_column='source', help_text='dct:source - source dataset this one is derived from', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='derived_datasets', to='warehouse.dataset', verbose_name='Source')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_name', models.ForeignKey(db_column='dataset_name', help_text='Dataset this distribution belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='distributions', to='warehouse.dataset', verbose_name='Dataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution', models.ForeignKey(db_column='distribution_name', help_text='Distribution this table belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='tables', to='warehouse.distribution', verbose_name='Distribution')),
            ],
            options={
                'verbose_name': 'Table',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table', models.ForeignKey(db_column='table_name', help_text='Table this column belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='columns', to='warehouse.table', verbose_name='Table')),
            ],
            options={
                'verbose_name': 'Column',
