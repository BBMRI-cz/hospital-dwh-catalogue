    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_name', models.SlugField(help_text='Dataset metadata field used as the catalogue query parameter.', max_length=80, unique=True, verbose_name='Field name')),
                ('label', models.CharField(help_text='Human-readable filter group title shown in the sidebar.', max_length=120, verbose_name='Label')),
                ('sort_order', models.PositiveIntegerField(default=0, help_text='Lower numbers are shown first.', verbose_name='Sort order')),
