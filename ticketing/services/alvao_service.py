...
class AlvaoService:
    ...
    def get_ticket(self, ticket_id: str) -> TicketInfo:
        ...
        return TicketInfo(
            ...
            requester_email=response_data.get('requesterEmail', response_data.get('requester', {}).get('email', '')),
