    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_value', models.CharField(help_text='The value that was counted, e.g. "MiSeq"', max_length=500, verbose_name='Filter value')),
                ('count', models.IntegerField(blank=True, help_text='Number of records matching the filter; null means not yet synced', null=True, verbose_name='Count')),
