    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_point', models.ForeignKey(blank=True, help_text='Contact information for this agent', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='agents', to='fair_genomes.contactpoint', verbose_name='Contact Point')),
            ],
            options={
                'verbose_name': 'Agent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_name', models.ForeignKey(db_column='dataset_name', help_text='Dataset this distribution belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='distributions', to='fair_genomes.dataset', to_field='name', verbose_name='Dataset')),
            ],
            options={
