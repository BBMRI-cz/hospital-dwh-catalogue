# Generated by Django 5.2.9 on 2026-04-03 12:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('molgenis_table', models.CharField(help_text='MOLGENIS table name, e.g. "sequencing"', max_length=100, verbose_name='MOLGENIS table')),
                ('molgenis_column', models.CharField(help_text='Column name within the table, e.g. "sequencinginstrumentmodel"', max_length=200, verbose_name='MOLGENIS column')),
                ('display_label', models.CharField(blank=True, default='', help_text='Optional label for the chart. If blank, "table.column" is used.', max_length=300, verbose_name='Display label')),
                ('sort_order', models.PositiveIntegerField(default=0, help_text='Lower numbers are shown first on the distribution page.', verbose_name='Sort order')),
                ('is_active', models.BooleanField(default=True, help_text='Inactive definitions are not synced or displayed.', verbose_name='Active')),
                ('distribution', models.ForeignKey(help_text='DCAT Distribution whose detail page should show this chart.', on_delete=django.db.models.deletion.CASCADE, related_name='stat_definitions', to='fair_genomes.distribution', verbose_name='Distribution')),
            ],
            options={
