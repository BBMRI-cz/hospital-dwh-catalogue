# Generated by Django 5.2.9 on 2026-03-22 21:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_point', models.ForeignKey(help_text='dcat:contactPoint — mandatory per HealthDCAT-AP v6 (1..*)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='datasets', to='fair_genomes.contactpoint', verbose_name='Contact Point')),
