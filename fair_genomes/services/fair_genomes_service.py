...
class FairGenomesService:
    ...
    def session(self) -> requests.Session:
        ...
        if self._session is None:
            ...
            self._session.headers.update({
                ...
                'x-molgenis-token': self.api_token
            })
    ...
    def _execute_query(self, query: str, variables: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            raise FairGenomesAPIException(f"Failed to connect to API: {str(e)}")
        ...
        with transaction.atomic(using='fair_genomes_db'):
            for record in records:
                try:
                    ...
                    personal, created = Personal.objects.using('fair_genomes_db').update_or_create(
